    ...
    var $tzLayoutAdmin = $.tzLayoutAdmin  = function(options,el) {
        ...
        var popover = function () {
            ...
            $('a[rel="rowpopover"]').popover({
                ...
                template: '<div class="popover"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"><div class="popover-body"><p></p></div></div><a class="btn btn-primary" onclick="jQuery(this).closest(\'.popover\').prevAll(\'a[rel=rowpopover]\').popover(\'hide\'); jQuery(this).closest(\'.popover\').prevAll(\'a[rel=rowpopover]\').show(); "><i class="icon-ok"></i> Apply</a></div></div>'
            }).click(function () {
                $(this).show();
                return false;
            });
