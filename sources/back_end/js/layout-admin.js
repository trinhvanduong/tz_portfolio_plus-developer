...
//                    }
        ...
        $("#content,#element-box").delegate("a.add-row", 'click', function () {
            var $item = $(this);
            $.get($var.pluginPath + '/new-row.php?time=' + $.now(), function ($row) {
        ...
        var addColumn = function ($selector) {
            $.get($var.pluginPath + '/new-column.php?time=' + $.now(), function ($column) {
...
//        }
        ...
        var addRowInColumn = function () {
            $("#content,#element-box").delegate("a.add-rowin-column", 'click', function () {
                var $this = $(this);
                $.get($var.pluginPath + '/new-row-in-column.php?time=' + $.now(), function ($row) {
