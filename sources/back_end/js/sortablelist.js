...
(function ($) {
    $.TZPortfolioPlusSortableList = function (tableWrapper, formId, sortDir, saveOrderingUrl, options, nestedList) {
        var root = this;
        ...
        $(tableWrapper).sortable({
            ...
            stop:function (e, ui) {
                ...
                if (saveOrderingUrl) {
                    ...
                    var ft2 = $('input[name|="addon_task"]', f);

                    if (ft.length) ft.detach();

                    if (ft2.length) ft2.detach();
